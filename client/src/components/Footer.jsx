...
const Footer = () => {
  return (
    <motion.footer
      className="bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 text-white py-6 px-4 text-center"
    ...
    >
      ...
      >
        &copy; {new Date().getFullYear()} <span className="font-semibold">Notes App MERN</span> | All Rights Reserved
      </motion.div>
